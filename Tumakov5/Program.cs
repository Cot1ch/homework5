...
namespace Tumakov5
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Task3();
            Task4(args);
            Task5(); //Нерабочая дичь, я с ней так и не разобрался
            Task6();
        ...
        /// <summary>
        /// Упражнение 6.2. Найти произведение двух матриц, вводимых с консоли.
        ...
        /// <summary>
        /// Домашнее задание 6.1. В аргументы Main/консоль передаются названия файлов из папки resourses.
        /// Метод выводит количество гласных и согласных в файле. Используется List char.
        /// </summary>
        /// <returns>-</returns>
        ...
        /// <summary>
        /// Эта хрень не работает. Но запускается
        ...
        static void Task5() ///Дописать!!!!!!!!!!!
        {
            ...
            for (int i = 0; i < widFirst; i++)
            {
                ...
                secondMatrix.AddLast(line);
                line.Clear();
            }

            var current = firstMatrix.First;
            while (current != null)
            {
                Console.WriteLine(current.Value);
                var current2 = current.Value.First;
                while (current2 != null)
                {
        ...
        /// <summary>
        /// Домашнее задание 6.3. Посчитать среднюю температуру по месяцам. Используется словарь
        /// </summary>
        /// <returns>-</returns>
        static void Task6()
        {
        ...
        /// <summary>
        /// К Task3. Возвращает отсортированный по возрастанию массив средних температур по месяцам.
        /// </summary>
        ...
        /// <summary>
        /// К Task1. Метод принимает массив символов и выводит количество гласных и согласных букв 
        /// английского и русского алфавитов в нём.
        /// </summary>
        /// <returns>-</returns>
        ...
        /// <summary>
        /// К Task4. Метод принимает List char и выводит количество гласных и согласных букв 
        /// английского и русского алфавитов в нём.
        /// </summary>
        /// <returns>-</returns>
        ...
        /// <summary>
        /// К Task 1 и Task 4. Метод открывает файл по переданному пути и выводит содержимое в строке
        /// </summary>
