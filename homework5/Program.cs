...
namespace homework5
{
    internal class Program
    {
        ...
        /// 3 задание. Бабушки (имя, возраст, болезни и лекарства) и больницы (название, болезни, вместимость). Первые - очередь, вторые - стек.
        /// Если в больнице лечат больше 50% болезней бабушки, она идёт туда. Если не лечат нигде -> на улицу плакать. Если просто спросить (болезней нет) -> в первую свободную.
        /// </summary>
        /// <returns>-</returns>
        static void Task3()
        {
        ...
        /// <summary>
        /// Задание 4. Обход графа в длину и ширину
        /// :((
        /// </summary>
        /// <returns>-</returns>
        static void Task4()
